...
`Codex-Hybrid-macOS-Full-Local-Setup-v2.18.8.zip` is the supported macOS
...
The v2.18.8 shared router preserves message, reasoning, function-call, usage,
...
`dist/Codex-Hybrid-macOS-Full-Local-Setup-v2.18.8.zip`.
