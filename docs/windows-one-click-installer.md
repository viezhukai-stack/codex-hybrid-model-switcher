...
```text
Codex-Hybrid-Windows-Netdisk-Setup-v2.15.5.zip
```
...
1. Download `Codex-Hybrid-Windows-Netdisk-Setup-v2.15.5.zip` from the netdisk
   link.
2. Extract the zip.
...
```text
dist\Codex-Hybrid-Windows-Netdisk-Setup-v2.15.5.zip
```
...
```powershell
py scripts\build-windows-one-click-package.py `
  --output dist\Codex-Hybrid-Windows-Full-Local-Setup-v2.15.5.zip `
