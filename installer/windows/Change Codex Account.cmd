...
set "PAYLOAD_SCRIPT=%~dp0payload\codex-hybrid-model-switcher\scripts\windows-change-account.ps1"
set "INSTALLED_SCRIPT=%LOCALAPPDATA%\CodexHybridModelSwitcher\releases\v%PACKAGE_VERSION%\project\scripts\windows-change-account.ps1"
...
if exist "%INSTALLED_SCRIPT%" (
  ...
  echo Codex account switch script was not found.
