...
set "PAYLOAD_SCRIPT=%~dp0payload\codex-hybrid-model-switcher\scripts\windows-update-repair.ps1"
set "INSTALLED_SCRIPT=%LOCALAPPDATA%\CodexHybridModelSwitcher\releases\v%PACKAGE_VERSION%\project\scripts\windows-update-repair.ps1"
...
if exist "%INSTALLED_SCRIPT%" (
  ...
  echo Codex Browser and CLI repair script was not found.
