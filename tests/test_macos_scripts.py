...
def test_macos_one_click_installer_has_safe_beginner_boundaries():
    ...
    assert "The lightweight macOS package is cloud-only." in readme
    assert "The full local macOS package may include payload/models/local-gemma" in readme
    assert "No macOS package includes CC Switch, API keys, or Codex Desktop." in readme
