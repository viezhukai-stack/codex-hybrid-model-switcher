...
`Codex-Hybrid-Windows-Netdisk-Setup-v2.15.4.zip`, extract it, and double-click
...
package named `Codex-Hybrid-Windows-Full-Local-Setup-v2.15.4.zip`. That package
