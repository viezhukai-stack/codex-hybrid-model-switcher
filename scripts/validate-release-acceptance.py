...
REQUIRED_FILES = (
    ...
    "docs/windows-live-audio-repair.md",
    ...
    "scripts/Repair Codex Live Audio.cmd",
    ...
    "installer/windows/Repair Codex Update and Plugins.cmd",
    "installer/windows/Repair Codex Live Audio.cmd",
